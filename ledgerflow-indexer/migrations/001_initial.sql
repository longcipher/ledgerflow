...
CREATE INDEX IF NOT EXISTS idx_deposit_events_chain_name ON deposit_events (chain_name);
...
CREATE INDEX IF NOT EXISTS idx_chain_states_chain_contract ON chain_states (chain_name, contract_address);
